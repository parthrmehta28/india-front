      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 max-w-6xl mx-auto items-stretch">
          ...
          <AnimateOnScroll className="h-full">
            <Card className="shadow-xl border-0 bg-gradient-to-br from-indigo-50 via-blue-50 to-indigo-100 h-full flex flex-col border border-indigo-200/50 relative overflow-hidden">
              {/* Background pattern for the card */}
              <div className="absolute inset-0">
                <div className="absolute top-4 right-4 w-24 h-24 bg-indigo-100/30 rounded-full blur-xl"></div>
                <div className="absolute bottom-4 left-4 w-16 h-16 bg-blue-200/20 rounded-full blur-lg"></div>
              </div>
              
              <CardHeader className="text-center pb-4 sm:pb-6 relative z-10">
                <div className="bg-indigo-200/60 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                  <PenTool className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-indigo-700" />
                </div>
                <CardTitle className="headline-secondary text-lg sm:text-xl md:text-2xl lg:text-3xl text-indigo-900">
                  Editorial
                </CardTitle>
                <CardDescription className="text-sm sm:text-base md:text-lg text-indigo-700/80 px-2 sm:px-0">
              ...
              <CardContent className="text-center space-y-4 sm:space-y-6 flex-grow flex flex-col px-3 sm:px-6 relative z-10">
                <div className="space-y-3 sm:space-y-4 flex-grow">
                  <div className="bg-indigo-100/60 backdrop-blur-sm border border-indigo-200/50 p-3 sm:p-4 rounded-lg h-20 sm:h-24 flex flex-col justify-center">
                    <h4 className="font-semibold text-indigo-900 mb-1 sm:mb-2 text-sm sm:text-base">Guest Articles</h4>
                    <p className="text-indigo-700 text-xs sm:text-sm">Contribute thought leadership pieces on growth sectors</p>
                  </div>
                  <div className="bg-indigo-100/60 backdrop-blur-sm border border-indigo-200/50 p-3 sm:p-4 rounded-lg h-20 sm:h-24 flex flex-col justify-center">
                    <h4 className="font-semibold text-indigo-900 mb-1 sm:mb-2 text-sm sm:text-base">Press Releases</h4>
                    <p className="text-indigo-700 text-xs sm:text-sm">Share important announcements and industry updates</p>
                  </div>
                  <div className="bg-indigo-100/60 backdrop-blur-sm border border-indigo-200/50 p-3 sm:p-4 rounded-lg h-20 sm:h-24 flex flex-col justify-center">
                    ...
                    <p className="text-indigo-700 text-xs sm:text-sm">Collaborate with our editorial team.</p>
                  </div>
                </div>
                ...
                >
                  <Button 
                    className="w-full h-10 sm:h-12 text-sm sm:text-base md:text-lg font-semibold bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white transition-all duration-300"
                ...
                <p className="text-sm sm:text-base font-medium text-indigo-800">
