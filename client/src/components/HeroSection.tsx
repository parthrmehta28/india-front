          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
            ...
            <motion.div className="lg:text-left text-center px-4 lg:px-0" variants={itemVariants}>
              ...
              <p className="body-text mb-8 lg:mb-12 max-w-lg lg:mx-0 mx-auto text-base lg:text-lg leading-relaxed">
                The magazine's focus lies in moving beyond criticism towards solutions across key growth sectors, thus helping to grow our country's economy. India Front is a theme-based magazine, so every edition will focus on a particular theme or a growth sector.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <g transform="translate(240, 180)">
                  <circle r="30" fill="url(#journalismCore)" stroke="rgba(255,255,255,0.8)" strokeWidth="2" filter="url(#glow)">
                    <animate attributeName="r" values="30;35;30" dur="4s" repeatCount="indefinite"/>
                  </circle>
                  <circle r="18" fill="rgba(255,255,255,0.3)"/>
                  
                  {/* Article/document icon */}
                  <g transform="translate(-6, -6)">
                    <rect x="1" y="1" width="10" height="8" rx="1" fill="white" fillOpacity="0.9"/>
                    <rect x="2" y="2" width="6" height="1" fill="rgba(0,88,202,0.8)"/>
                    <rect x="2" y="4" width="4" height="0.8" fill="rgba(0,88,202,0.6)"/>
