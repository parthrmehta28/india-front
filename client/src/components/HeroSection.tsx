        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <motion.div className="lg:text-left text-center order-1 lg:order-1" variants={itemVariants}>
              <h1 className="headline-primary text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mb-3 sm:mb-4 md:mb-6 lg:mb-8 leading-tight text-center lg:text-left px-2 sm:px-4 lg:px-0">
                Through Unfiltered Lens: Chronicling<br /> India's Economic Success with<br /> Intent-Driven Journalism
              </h1>
