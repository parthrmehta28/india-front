      ...
      <div className="container mx-auto px-4">
        <AnimateOnScroll className="max-w-4xl mx-auto">
          ...
          <div className="bg-light-gray rounded-lg p-8 shadow-md">
            <p className="text-lg font-nunito mb-6 leading-relaxed">
            ...
            <p className="text-lg font-nunito font-semibold mb-4">India Front exists to:</p>
            <ul className="list-disc pl-8 space-y-3 mb-6 text-lg font-nunito">
