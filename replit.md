...
- June 27, 2025. Significantly compacted contact forms with grid layout: reduced vertical height by 50% using grid columns for related fields, smaller text sizes, reduced padding, and shorter textarea rows for better page proportion
